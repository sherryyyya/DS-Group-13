...
library(tidyverse)
library(modelr)
ev_data <- read_csv("C:/Study/CMU/19603_Data_Science/Final_Project/19603_Final_Project/Proposal copy/Electric_Vehicle_Population_Data.csv")
demo_data <- read.csv("C:/Study/CMU/19603_Data_Science/Final_Project/19603_Final_Project/Proposal copy/demo.csv")
population_by_postal_code <- read.csv("C:/Study/CMU/19603_Data_Science/Final_Project/19603_Final_Project/Proposal copy/Pupulation by Postal Code.csv")
income_by_postal_code <- read.csv("C:/Study/CMU/19603_Data_Science/Final_Project/19603_Final_Project/Proposal copy/Income by Postal Code.csv")
charge_station <- read.csv("C:/Study/CMU/19603_Data_Science/Final_Project/19603_Final_Project/Proposal copy/Charge Station.csv")
education <- read.csv("C:/Study/CMU/19603_Data_Science/Final_Project/19603_Final_Project/Proposal copy/education by postal code.csv")
population_density_by_postal_code <- read.csv("C:/Study/CMU/19603_Data_Science/Final_Project/19603_Final_Project/Proposal copy/Population density by postal code1.csv")
urbanization <- read.csv("C:/Study/CMU/19603_Data_Science/Final_Project/19603_Final_Project/Proposal copy/urban by zip code.csv")
Vehicle_adoption <- read.csv("C:/Study/CMU/19603_Data_Science/Final_Project/19603_Final_Project/Proposal copy/Vehicle_Registration.csv")
EV_2020 <- read.csv("C:/Study/CMU/19603_Data_Science/Final_Project/19603_Final_Project/Proposal copy/Vehicle_Registration_2020.csv")
EV_2021 <- read.csv("C:/Study/CMU/19603_Data_Science/Final_Project/19603_Final_Project/Proposal copy/Vehicle_Registration_2021.csv")
EV_2022 <- read.csv("C:/Study/CMU/19603_Data_Science/Final_Project/19603_Final_Project/Proposal copy/Vehicle_Registration_2022.csv")
EV_2023 <- read.csv("C:/Study/CMU/19603_Data_Science/Final_Project/19603_Final_Project/Proposal copy/Vehicle_Registration_2023.csv")
```
